...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Create unique fantasy names as identifier for your activerecord objects}
  spec.description   = %q{This gem allows you to create unique readable fantasy names as identifiers for your active record objects. You can also define multiple identifier columns and alternatively use a UUID or Devise.friendly_token as identifier.}
